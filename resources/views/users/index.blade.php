                                ...
                                <td class="px-6 py-4 whitespace-nowrap ">
                                    ...
                                    <div class="flex justify-center">
                                        ...
                                        <form action="{{ route('users.destroy', $user->id) }}" method="POST">
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="btn-actions inline-flex items-center flex-grow px-4 py-2 ml-4 bg-gray-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-wider hover:bg-red-700 active:bg-red-900">
                                                {{ __('Delete') }}
                                            </button>
                                        </form>
                                    </div>
