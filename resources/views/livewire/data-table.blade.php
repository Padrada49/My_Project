<div>
    ...
    <div class="fixed z-10 inset-0 overflow-y-auto hidden" id="modal-view" aria-labelledby="modal-view-title" role="dialog" aria-modal="true">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    ...
                    <form>
                        <div class="grid gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <select name="roles" id="roles" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" disabled>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:py-4">
                    <div class="flex flex-row-reverse">
                        <button type="button" class="hidden btn-sm-update mt-3 w-full inline-flex justify-center rounded-md bg-indigo-500 border border-transparent shadow-sm px-4 py-2 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:ml-3 sm:w-auto sm:text-sm">
                            อัพเดทข้อมูล
                        </button>
                        <button type="button" class="btn-sm-close mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:ml-3 sm:w-auto sm:text-sm">
                            ปิด
                        </button>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
            ...
            ajax: {
                ...
                beforeSend: function(xhr) {
                    xhr.setRequestHeader('Authorization',
                        'Bearer LBcocZT19NPkZhyi9P3hMa7AgKgVSCCmpEi8Kn7fd1145d73');
                }
            },
            columns: [{
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        return `
                                <div class="flex justify-center">
                                        ...
                                        <button type="submit"
                                            class="btn-delete btn-actions inline-flex items-center flex-grow px-4 py-2 ml-4 bg-gray-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-wider hover:bg-red-700 active:bg-red-900">
                                            {{ __('Delete') }}
                                        </button>
        ...
        $(document).on('click', '.btn-sm-update', function() {
            ...
            const roles_id = document.getElementById('roles').value;
            Swal.fire({
